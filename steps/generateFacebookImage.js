...
export async function generateFacebookImage(caption) {
  console.log("Starting Facebook Image Generation (Model: gemini-3-pro-image-preview)...");
...
Context from caption: ${caption.substring(0, 200)}...
  ...
  // 3. API Call to Gemini 3 Preview
  ...
  if (!data.predictions) throw new Error("No predictions from Gemini.");
